...
使用SRS搭建直播，虽然能看到直播的全链路过程，但有个明显的问题，就是这里只有一台SRS服务器，能支持的观看人数是有限的，除了少数场景的流很少，一般都需要支持成百上千甚至上万人观看。可以用多台SRS组成集群，可以支持更多人观看，我们不展开讲这个实现，可以参考[SRS集群](https://github.com/ossrs/srs/wiki/v4_CN_Home#cluster-guides)。
