...
* 一台云主机，带公网IP。推荐[Oryx](./SRS-Stack-Tutorial)，带有音视频服务器Oryx，腾讯云Lighthouse或CVM有Oryx镜像，其他云主机可以用宝塔安装。
...
推荐使用Oryx，因为后面也可以用于连麦。最方便的部署SRS的方式使用[Oryx](./SRS-Stack-Tutorial)，可以用腾讯云镜像一键部署，其他云或自己虚拟机可以用宝塔部署，具体请参考[视频教程](https://www.bilibili.com/video/BV1844y1L7dL/)。
...
若使用开源搭建，推荐SRS服务器。最方便的部署SRS的方式使用[Oryx](./SRS-Stack-Tutorial)，可以用腾讯云镜像一键部署，其他云或自己虚拟机可以用宝塔部署，具体请参考[视频教程](https://www.bilibili.com/video/BV1844y1L7dL/)。
