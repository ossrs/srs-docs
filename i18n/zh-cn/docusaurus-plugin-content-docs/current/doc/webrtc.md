...
关于SRS的WebRTC API，请参考[publish](https://github.com/ossrs/srs/wiki/v5_CN_HTTPApi#webrtc-publish)和[play](https://github.com/ossrs/srs/wiki/v5_CN_HTTPApi#webrtc-play).
