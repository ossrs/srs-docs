...
就会把url带过去验证。参考：[HTTP callback](http://ossrs.net/srs.release/wiki/v4_CN_HTTPCallback)
...
参考：[HTTP callback](http://ossrs.net/srs.release/wiki/v4_CN_HTTPCallback#config-srs)
