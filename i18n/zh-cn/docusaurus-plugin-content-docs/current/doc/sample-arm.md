...
某些编译非常慢，或者没有编译器的嵌入式平台，才需要交叉编译，请参考[这里](https://github.com/ossrs/srs/wiki/v4_CN_SrsLinuxArm).
...
详细参考：[SrsLinuxArm](https://github.com/ossrs/srs/wiki/v4_CN_SrsLinuxArm**)
