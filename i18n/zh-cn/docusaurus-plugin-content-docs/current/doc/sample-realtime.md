...
配置最低延迟的服务器详细信息可以参考：[LowLatency](https://github.com/ossrs/srs/wiki/v4_CN_LowLatency)，本文举例说明部署的实例步骤。
...
详细参考[LowLatency](https://github.com/ossrs/srs/wiki/v4_CN_LowLatency)
