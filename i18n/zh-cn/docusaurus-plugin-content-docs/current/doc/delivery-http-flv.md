...
备注：HTTP服务器配置，参考[HTTP Server](http://ossrs.net/srs.release/wiki/v4_CN_HTTPServer#config)
...
一步一步配置HTTP FLV： [Sample](http://ossrs.net/srs.release/wiki/v4_CN_SampleHttpFlv)
...
关于HTTP flv 点播流，参考：[v4_CN_FlvVodStream](http://ossrs.net/srs.release/wiki/v4_CN_FlvVodStream)
