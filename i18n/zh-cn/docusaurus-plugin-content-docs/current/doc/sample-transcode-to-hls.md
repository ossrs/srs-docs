...
HLS需要h.264+aac，若符合这个要求可以按照[Usage: HLS](http://ossrs.net/srs.release/wiki/v4_EN_DeliveryHLS)部署，若不符合这个要求则需要转码。

如何知道流是否是h264+aac编码：
* [Usage: HLS](http://ossrs.net/srs.release/wiki/v4_EN_DeliveryHLS)中的`Q&A`说明的问题。
