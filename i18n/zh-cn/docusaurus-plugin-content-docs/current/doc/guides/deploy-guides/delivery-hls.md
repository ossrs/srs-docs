...
vhost __defaultVhost__ {
    hls {
        ...
        # @see https://github.com/ossrs/srs/wiki/v4_CN_DeliveryHLS#hls-config
        ...
        # @read https://github.com/ossrs/srs/wiki/v4_CN_DeliveryHLS#http-callback
        # @read https://github.com/ossrs/srs/wiki/v4_CN_DeliveryHLS#http-callback
        ...
        # @read https://github.com/ossrs/srs/wiki/v4_CN_DeliveryHLS#on-hls-notify
        # @read https://github.com/ossrs/srs/wiki/v4_CN_DeliveryHLS#on-hls-notify
    }
}
```
...
* hls_ts_file: HLS的ts文件名，包含可替换的一系列变量，参考[dvr variables](http://ossrs.net/srs.release/wiki/v4_CN_DVR#custom-path)，另外，[seq]是ts的seqence number。
```bash
...
SRS支持分发HLS纯音频流，当RTMP流没有视频，且音频为aac（可以使用转码转为aac，参考[Usage: Transcode2HLS](http://ossrs.net/srs.release/wiki/v4_CN_SampleTranscode2HLS)），SRS只切片音频。
