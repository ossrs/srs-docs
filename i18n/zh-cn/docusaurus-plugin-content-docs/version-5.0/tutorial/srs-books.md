...
* [《零声学院：SRS流媒体服务器实战》](https://www.bilibili.com/video/BV1XZ4y1P7um)
* [《夏立新：SRS代码分析》](https://github.com/xialixin/srs_code_note/blob/master/doc/srs_note.md)
* [《罗上文：SRS原理》](https://srs.xianwaizhiyin.net/)
...
* SRS是单进程模型，不支持多进程；可以使用[集群](https://mp.weixin.qq.com/s/pd9YQS0WR3hSuHybkm1F7Q) 或者[ReusePort](../doc/reuse-port.md)扩展多进程(多核)能力。
...
* [Third-party Client SDK](../doc/client-sdk.md): 第三方厂商提供的客户端推流和播放的SDK，一般是移动端包括Andoird和iOS。
...
![](https://ossrs.net/gif/v1/sls.gif?site=ossrs.net&path=/lts/tutorial/zh/v5/srs-books)