...
就会把url带过去验证。参考：[HTTP callback](https://ossrs.net/lts/zh-cn/docs/v4/doc/http-callback)
...
参考：[HTTP callback](https://ossrs.net/lts/zh-cn/docs/v4/doc/http-callback#config-srs)
