...
HLS需要h.264+aac，若符合这个要求可以按照[Usage: HLS](https://ossrs.io/lts/en-us/docs/v4/doc/delivery-hls)部署，若不符合这个要求则需要转码。

如何知道流是否是h264+aac编码：
* [Usage: HLS](https://ossrs.io/lts/en-us/docs/v4/doc/delivery-hls)中的`Q&A`说明的问题。
