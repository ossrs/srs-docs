...
RTMP和HLS的优势参考：[HLS](http://ossrs.net/srs.release/wiki/v4_CN_DeliveryHLS)
...
SRS的demo.conf配置文件中，包含了demo用到的一些vhost，参考[Usage: Demo](http://ossrs.net/srs.release/wiki/v4_CN_SampleDemo)。
