...
开发代号：Free。2026年开始开发，正在进行中。

> 代号故事：Free 代表 AI 时代开源开发的新纪元。既是 freedom（自由），也是 free（免费）——AI 智能体不仅仅是免费的劳动力，它就像我自己的一个副本，甚至是几十个副本，都深入理解这个项目，知道如何交付高质量的代码，如何服务社区。AI 承担了所有繁琐的工作——枯燥的任务、文档、编码——而且往往做得比我自己更好，能力是我的十倍。我们为社区构建了一个 AI 机器人来回答问题、帮助用户学习这个项目；我们还用 AI 几乎完全重写了 SRS Proxy 服务器——它的结构、它的工作流——让 AI 智能体可以全面地管理和维护它。有了 AI，我拥有了力量，也拥有了选择：不再等待其他开发者来贡献，我可以自由地管理这个项目，从独自维护的劳作中解放出来。这是一个奇妙而美好的新时代，一个属于开源项目和开源社区的新时代。

SRS 8.0 于 2026 年开始开发。
