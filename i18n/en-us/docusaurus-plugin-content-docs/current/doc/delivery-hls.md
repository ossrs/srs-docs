...
Servers delivering both HLS and RTMP can support all screens. For RTMP, see: [RTMP Delivery](https://ossrs.net/lts/zh-cn/docs/v4/doc/delivery-rtmp)。

For information comparing RTMP and HLS, read [RTMP PK HLS](https://ossrs.io/lts/en-us/docs/v4/doc/rtmp-pk-http).

For information about how to deploy SRS to support HLS, read [Usage: HLS](https://ossrs.net/lts/zh-cn/docs/v4/doc/sample-hls).

For cluster to deliver HLS, to serve a vast set of visitors, please see [Nginx for HLS](https://ossrs.io/lts/en-us/docs/v4/doc/nginx-for-hls).
...
* hls_ts_file: The filename of the ts file, with some variables in [dvr variables](https://ossrs.io/lts/en-us/docs/v4/doc/dvr#custom-path). And, variable [seq] is the ts seqence number.
```bash
...
For how to deploy SRS to deliver HLS, read [Usage: HLS](https://ossrs.net/lts/zh-cn/docs/v4/doc/sample-hls)
...
SRS support delivering pure audio stream by HLS. The audio codec requires AAC, user must transcode other codecs to AAC, read [Usage: Transcode2HLS](https://ossrs.io/lts/en-us/docs/v4/doc/sample-transcode-to-hls)

For information about dropping video, read [Transcode: Disable Stream](https://ossrs.io/lts/en-us/docs/v4/doc/ffmpeg#drop-video-or-audio)

There is no special configuration for pure audio for HLS. Please read [Usage: HLS](https://ossrs.net/lts/zh-cn/docs/v4/doc/sample-hls)
