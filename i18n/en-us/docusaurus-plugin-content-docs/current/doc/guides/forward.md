...
Note: The information about edge, read [Edge](https://github.com/ossrs/srs/wiki/v4_EN_Edge),
...
For the usage of forward, read [Usage: Forward](https://github.com/ossrs/srs/wiki/v4_EN_SampleForward)
