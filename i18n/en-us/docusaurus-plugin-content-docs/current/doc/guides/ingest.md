...
How to deploy ingest, read [Ingest](https://github.com/ossrs/srs/wiki/v4_EN_SampleIngest)
...
Config SRS with option `--with-ingest`, read [Build](https://github.com/ossrs/srs/wiki/v4_EN_Build)
...
* others is same to [FFMPEG](https://github.com/ossrs/srs/wiki/v4_EN_FFMPEG)
