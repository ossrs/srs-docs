...
* `tcp://8080`, HTTP live streaming server, [HTTP-FLV](./sample-http-flv.md), [HLS](./hls.md) as such.
...
![](https://ossrs.net/gif/v1/sls.gif?site=ossrs.io&path=/lts/doc/en/v6/resource)
