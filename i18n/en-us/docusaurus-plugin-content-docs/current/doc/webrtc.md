...
About the API for WebRTC, please read [publish](https://github.com/ossrs/srs/wiki/v5_EN_HTTPApi#webrtc-publish) and [play](https://github.com/ossrs/srs/wiki/v5_EN_HTTPApi#webrtc-play).
