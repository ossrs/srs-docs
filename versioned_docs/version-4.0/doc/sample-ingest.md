...
then publish to SRS. For detail, read [Ingest](https://ossrs.io/lts/en-us/docs/v4/doc/ingest).
...
For detail, read [Ingest](https://ossrs.io/lts/en-us/docs/v4/doc/ingest)
