...
For information about the dvr option, read [Build](https://github.com/ossrs/srs/wiki/v4_EN_Build)
...
User can use [http raw api](https://github.com/ossrs/srs/wiki/v4_EN_HTTPApi) to control when to dvr specified stream.
...
About the RAW API to control DVR, read [319](https://github.com/ossrs/srs/issues/319) and [wiki](https://github.com/ossrs/srs/wiki/v4_EN_HTTPApi#raw-dvr).
...
For more information, read about [HttpCallback](https://github.com/ossrs/srs/wiki/v4_EN_HTTPCallback)
