...
For token authentication based on HTTP callbacks, read [Token Authentication](http://ossrs.net/srs.release/wiki/v4_EN_DRM#token-authentication)

## Compile

SRS always enable http callbacks.

For more information, read [Build](http://ossrs.net/srs.release/wiki/v4_EN_Build)
...
If success, you must response `something` to identify the success, or SRS will reject the client, which enable you to reject the illegal client, please read [Callback Error Code](http://ossrs.net/srs.release/wiki/v4_EN_HTTPApi#error-code). 
...
The HttpCallback can used to snapshot, please read [snapshot](https://github.com/ossrs/srs/wiki/v4_EN_Snapshot#httpcallback)
